...
const UpdateRestaurant = () => {
    ...
    let UpdateRestaurant = gql`
        mutation Mutation($resName: String!, $updateResId: ID) {
            updateRes(res_name: $resName, id: $updateResId)
        }`;

    const [updateRes] = useMutation(UpdateRestaurant);
    ...
    const handleUpdateOhirgi = async (e) => {
        try {
            e.preventDefault()
            const res_name = catgoryNameRef.current.value
            const { data } = await updateRes({
                variables: { resName: res_name, updateResId: id },
                context: {
                    headers: {
                        authorization: `${token}`,
                    },
            ...
            if (data) {
                toast("Success updated Category", { type: "success" })
            }
        ...
        <div className=''>
            ...
            <div className='urab'>
                <div className='container-fluid  d-flex'>
                    ...
                    <section>
                        <div className="container">
                            <h3 className='ko text-danger py-2'>Update Restaurant</h3>
                                    ...
                                    <div key={item._id} className="cardb d-flex">
                                        ...
                                        <div className='lol'>
                                            ...
                                            <div className='d-flex align-items-center justify-content-between mt-4'>
                                                ...
                                                <Link>
                                                    <button onClick={() => handleUpdateSubmit(item._id)} className='btn btn-danger' type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" >
                                                        Update Category
                                                    </button>
                                                </Link>
                                            </div>
                    ...
                    <div className="offcanvas offcanvas-end bg-dark" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                        ...
                        <div className="offcanvas-body">
                            <form action="" onSubmit={handleUpdateOhirgi} >
                                <label className='text-white mt-2' htmlFor="res_name">Category Name</label>
                                <input type="text" ref={catgoryNameRef} className='form-control mt-1' name='res_name' id='res_name' />
